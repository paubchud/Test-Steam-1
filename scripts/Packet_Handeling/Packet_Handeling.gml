///@self obj_server
//[Begin Step]: send updated player list when a player joins
...
///@self obj_server
//[Begin Step]: When recived, loop through players to update all
...
///@self obj_server
//[Async]: Request data from new player
...
///@self obj_client
//[Create]: On joining, send host player data
function send_player_data(data){
	...
	steam_net_packet_send(steam_lobby_get_owner_id(), _b,1)
	show_debug_message("[Cpacket] Data Sent")
	buffer_delete(_b)
}

///@self obj_client
//[Step]: On movement, update player position
